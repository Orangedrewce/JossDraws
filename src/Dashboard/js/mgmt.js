(function () {
  ...
  // ============================================
  {
    ...
    function openEditModal(id) {
      ...
      function updateEditActivePreview() {
        const isActive = activeToggle.dataset.active === "true";
        previewSubtext.textContent = isActive
          ? "✅ Visible on site"
          : "🚫 Hidden from site";
      }
  ...
  // ============================================
  {
    ...
    const PARAM_MAP = [
      ...
      {
        path: "thickness.stretchMin",
        id: "thickness-stretchMin",
        type: "range",
      },
      {
        path: "thickness.stretchMax",
        id: "thickness-stretchMax",
        type: "range",
      },
      {
      ...
      {
        path: "wave.horizontalSpeed",
        id: "wave-horizontalSpeed",
        type: "range",
      },
      {
  ...
  `;
    ...
    function buildRibbonShader(cfg) {
...
`;
    ...
    /* ── Rebuild both shader programs (hot-swap on param change) ── */
